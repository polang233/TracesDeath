...
class CorpseItemsTest {
    ...
    @Test void restoreReplacesOriginalEquipmentAndOnlyDropsDisplacedItems() {
        var before = Map.of(0, item(Material.STONE, 64), 39, item(Material.GOLDEN_HELMET, 1),
                40, item(Material.TORCH, 8), 5, item(Material.EMERALD, 5));
        var source = Map.of(0, item(Material.DIAMOND, 12), 39, item(Material.DIAMOND_HELMET, 1),
                40, item(Material.SHIELD, 1));
        ...
        assertEquals(List.of(Material.STONE, Material.GOLDEN_HELMET, Material.TORCH),
    ...
    @Test void inventoryModeDropsOnlyOverflowAndKeepsWornEquipment() {
        ...
        var plan = CorpseItems.planAll(before, Map.of(0, item(Material.DIAMOND, 12),
                39, item(Material.DIAMOND_HELMET, 1)), true, 64);
    ...
    @Test void extraDropsUseStorageAfterOriginalSlotsAreRestored() {
        var plan = CorpseItems.planAll(Map.of(1, item(Material.COAL, 1)),
                Map.of(0, item(Material.DIAMOND, 64), 41, item(Material.EMERALD, 12)), false, 64);
        assertEquals(Material.DIAMOND, plan.after().get(0).getType());
